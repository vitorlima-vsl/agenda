...
<body class="flex justify-center bg-gray-100">
    ...
    <div class="bg-white border-2 border-gray-50 border-rounder px-4 pt-4 pb-9  shadow md:mt-9 sm:h-3/4 sm:w-2/4 xl:w-1/4 overflow-hidden">
                ...
                @foreach ($contatos as $contato)
                    <div class="grid grid-cols-2 p-2 rounded shadow w-full" id="mainDiv">
                        <div class="">
                            ...
                            <div class="flex content-start justify-end relative">
