document.getElementById('addTelefone').addEventListener('click', function(event) {
    ...
    if (selects.length < 2) {
        ...
        removeButton.className = 'button hover:shadow-lg shadow-red-500/50 hover:shadow-red-500/100 bg-[#F5533B] border-red-400 hover:border-red-500 text-white font-bold py-2 px-4';
